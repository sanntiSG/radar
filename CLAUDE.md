...
Radar — Plataforma de Detección Temprana de Señales de Mercado para Ecommerce, emprendedores, etc.
...
* DEBEMOS ANALIZAR Y RESOLVER COMO CATEGORIZAR LAS CATEGORÍAS, ya que quizá detecte impresoras, pero hay miles de modelos, nombres de impresoras, etc.
...
4. RSS.
5. Scraping moderado.
6. NO USAR SERVICIOS DE PAGO O CON LÍMITES DE TOKENS

Utilizar:

* Playwright
* Puppeteer
* O lo que creas necesario 
